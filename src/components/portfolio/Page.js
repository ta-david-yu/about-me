    ...
    render() {
        ...
        return (
            <div>
                ...
                className={((this.props.windowWidth < 1024)? "sm-modal-size" : "lg-modal-size") + " modal"}
                ...
                closeTimeoutMS={300}>
                        ...
                        <img alt="return" className="modal-close-button" onClick={this.closeModal} src="/img/return-x40.png" />
                </Modal>
            </div>
        );
    }
